...
def test_parser():
	...
	parser.add_argument('-c', '--n_car', metavar = 'C', type = int, default = 3, help = 'number of available vehicles')
	...
	parser.add_argument('-p', '--path', metavar = 'P', type = str, default='Weights/VRP20_epoch26.pt',
						help = 'Weights/VRP***_epoch***.pt, pt file required')
	parser.add_argument('-t', '--txt', metavar = 'T', type = str, default='data/n20d3c3s123.json',
